...
const Footer = () => {
  const PageFacebook = () => {
    window.location.href =
      "https://www.facebook.com/SOHAwedding.nv?locale=vi_VN";
  };
  return (
        ...
        <div className="col-sm-6 col-lg-3 text-start">
          <ul>
            ...
            <li>
              <a>
                <Typography style={{ fontFamily: "Roboto", fontSize: "15px" }}>
                  <Link to="/Introduce" className="no-underline">
                    Giới Thiệu
                  </Link>
                </Typography>
              </a>
            ...
            <li>
              <a>
                <Typography style={{ fontFamily: "Roboto", fontSize: "15px" }}>
                  <Link to="/Price" className="no-underline">
                    Báo Giá
                  </Link>
                </Typography>
              </a>
            ...
            <li>
              <a>
                <Typography style={{ fontFamily: "Roboto", fontSize: "15px" }}>
                  <Link to="/Album" className="no-underline">
                    Album
                  </Link>
                </Typography>
              </a>
