...
import { listCardWedding, listImagesGiaDinh, listImagesWeddingPress ,listPhotoMake,listPhotoTraining,listPhotoVideoWeddingDay,listPhotoWedding } from "../mock-data/imagesFake";
import ListPhotoShow from "../common/ListPhotoShow/ListPhotoShow";
export const ChoThueVayCuoi = () => (
  <div className="elementor-widget-container">
    <h2 className="elementor-heading-title elementor-widget">
      <strong>Váy cưới mới nhất HOT TREND</strong>
      <p className="service-detail-p">
        Tại cửa hàng Soha, những chiếc váy cưới không chỉ đẹp mắt mà còn là biểu tượng của sự tinh tế và sang trọng. Mỗi thiết kế đều tỏa sáng với sự kỹ lưỡng trong từng đường nét, từ những đuôi váy lãng mạn đến những chi tiết ren hoa tinh tế. Cùng với đó, sự đa dạng về kiểu dáng và chất liệu giúp mỗi cô dâu tìm được chiếc váy phản ánh hoàn hảo cá tính và phong cách của chính mình.
      </p>
    </h2>
    <div className="elementor-container">
      <ListPhotoShow listPhoto={listImagesWeddingPress} />
    </div>
  </div>
);

export const ChupAnhCuoi = () => (
  <div className="elementor-widget-container">
    <p className="service-detail-p">
      SOHA WEDDING tự hào là thương hiệu chụp ảnh cưới nổi tiếng số 1 về phong
      ...
      cho album ảnh cưới. Ngoài ra, đến với SOHA cặp đôi còn được tư vấn thực
    ...
    <ul className="ul-1">
      <li className="service-detail-li">
        <strong className="service-detail-strong">
          Chụp ảnh cưới tại Studio độc quyền của SOHA WEDDING:{" "}
        </strong>
        ...
        SOHA nên những góc chụp là duy nhất, không bị trùng lặp với các phim
    ...
    <div className="elementor-container">
      <ListPhotoShow listPhoto={listPhotoWedding} />
    </div>

  </div>
);

export const ChupAnhGiaDinh = () => (
  <div className="service elementor-widget-container">
    ...
    <div className="elementor-container">
      <ListPhotoShow listPhoto={listImagesGiaDinh} />
    </div>
  </div>
);

export const ChupPhongSuNgayCuoi = () => (
  <div className="elementor-widget-container">
    <h2 className="elementor-heading-title elementor-widget">
    <div className="elementor-container">
      <ListPhotoShow listPhoto={listPhotoVideoWeddingDay} />
    </div>
    </h2>
  </div>
);

export const MakeupCoDau = () => (
  <div className="">
    <p className="service-detail-p">
    ...
    <p className="service-detail-p">
      Tại SOHA WEDDING có các dịch vụ make-up:
    </p>
    <ul className="ul-1">
    ...
    <p className="service-detail-p">
      ...
      nhà SOHA WEDDING luôn luôn nhận được sự hài lòng từ 100% khách hàng, đội
      ngũ nhân viên nhà SOHA luôn tư vấn nhiệt tình và cập nhật xu hướng
      make-up cô dâu mới nhất, đầu tư bộ trang điểm chuyên nghiệp cực chất
      lượng.{" "}
    </p>
    <p className="service-detail-p">
      SOHA Wedding cam kết dịch vụ make-up cho cô dâu:
    </p>
    <ul>
      <li className="service-detail-li">
    ...
    <div className="elementor-container">
      <ListPhotoShow listPhoto={listPhotoMake} />
    </div>
  </div>
);

export const ThiepCuoi = () => (
  <div className="elementor-widget-container">
    <p className="service-detail-p">
    ...
    <div className="elementor-container">
      <ListPhotoShow listPhoto={listCardWedding} />
    </div>
  </div>
);
...
export const DaoTaoNghe = () => (
  <div className="elementor-widget-container">
    <h2 className="elementor-heading-title elementor-widget">
    <div className="elementor-container">
      <ListPhotoShow listPhoto={listPhotoTraining} />
    </div>
    </h2>
  </div>
);
