...
import HeadPrice from "../common/head/head.jsx"
import MenuPrice from "../common/tavbar/Navbar.jsx"
import FootPrice from "../common/footer/Footer.jsx"
              ...
              {list.map((element , index )=>(
                  <div className="row">
                    <div className="col lg-6">
                        <img className="photo_price" key={index} src={element}/>
                    </div>
                  </div>
              ))}
            </div>
